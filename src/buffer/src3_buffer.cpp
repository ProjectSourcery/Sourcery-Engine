...
namespace src3 {
     ...
     */
    VkDeviceSize SrcBuffer::getAlignment(VkDeviceSize instanceSize, VkDeviceSize minOffsetAlignment) {
     ...
     *
     */
    void SrcBuffer::writeToIndex(void* data, int index) {
     ...
     *
     */
    VkResult SrcBuffer::flushIndex(int index) { return flush(alignmentSize, index * alignmentSize); }
     ...
     */
    VkDescriptorBufferInfo SrcBuffer::descriptorInfoForIndex(int index) {
     ...
     * @return VkResult of the invalidate call
     */
    VkResult SrcBuffer::invalidateIndex(int index) {
